...
namespace MiscUtil.Conversion
{
	...
	public abstract class EndianBitConverter
	{
		...
		public byte[] GetBytes(object value)
		{
			...
			else if(type == typeof(long))	return GetBytes((long)value);
			else if(type == typeof(bool))	return GetBytes((bool)value);
			else if(type == typeof(char))	return GetBytes((char)value);
			else if(type == typeof(double))	return GetBytes((double)value);
			else if(type == typeof(short))	return GetBytes((short)value);
			else if(type == typeof(int))	return GetBytes((int)value);
			else if(type == typeof(long))	return GetBytes((long)value);
			else if(type == typeof(float))	return GetBytes((float)value);
			else if(type == typeof(ushort))	return GetBytes((ushort)value);
			else if(type == typeof(uint))	return GetBytes((uint)value);
			else if(type == typeof(ulong))	return GetBytes((ulong)value);
